...
namespace MissPaulingBot.Migrations
{
    ...
    [Migration("20240118053009_ReportedMessages")]
    partial class ReportedMessages
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MissPaulingBot.Common.Models.Contest", b =>
                {
                    ...
                    b.Property<List<string>>("AcceptedFileTypes")
                        .IsRequired()
                        .HasColumnType("text[]")
                        .HasColumnName("accepted_file_types");
            ...
            modelBuilder.Entity("MissPaulingBot.Common.Models.ReportedMessage", b =>
                {
                    b.Property<decimal>("MessageId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("numeric(20,0)")
                    ...
                    b.ToTable("reported_messages", (string)null);
                });

            modelBuilder.Entity("MissPaulingBot.Common.Models.SaxtonOwnRole", b =>
                {
                    ...
                    b.HasKey("OwnerId")
                        .HasName("pk_saxton_own_roles");

                    b.ToTable("saxton_own_roles", (string)null);
                });
            ...
            modelBuilder.Entity("MissPaulingBot.Common.Models.StreamerApplication", b =>
                {
                    ...
                    b.Property<string>("PlatformAnswer")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("platform_answer");
            ...
            modelBuilder.Entity("MissPaulingBot.Common.Models.ToDo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("MissPaulingBot.Common.Models.VerificationEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
