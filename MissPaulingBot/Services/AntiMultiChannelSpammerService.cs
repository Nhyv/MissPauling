...
public class AntiMultiChannelSpammerService : DiscordBotService
{
    ...
    {
        if (e.Member is null || e.Member.RoleIds.Contains(Constants.MODERATOR_ROLE_ID) ||
            _alreadySoftbanned.Contains(e.Message.Author.Id) || e.Member.IsBot) return ValueTask.CompletedTask;
